...
_How many tourist attractions are there in the data set? A: 348 tourist attractions
...
_How many attraction had more than 1 million visitors in 2022? A: 22
...
NA stands for 'Not Available'. These median and mean values are NA because some n_2021 values for certain tourist attractions are NA. Mean and median calculations cannot be done.
...
Making na.rm = true will strip away the NA values before the computation of mean and median  



## Question 7

_Which setting (inside, outside or mixed) has the largest mean visitor numbers in 2022? A: Inside_
...
This suggests that there are some attractions with a very large visitor numbers that skew the mean statistic. Thus, making the mean much larger than the median.
